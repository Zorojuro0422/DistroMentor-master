...
export function PaymentReceiptDetails() {
    ...
    function getAllCollectorRemittanceProofDocuments() {
        axios.get<ICollectorRemittanceProof[]>(`http://localhost:8080anceproof/findAllCollectorProofByCollectionPaymentReceiptId/${objectId!}`)
            .then((response) => {
    ...
    useEffect(() => {
      ...
      // selectedBDate?.format('YYYY-MM-DD') || ''
    ...
    const handlePrint = () => {
        console.log("hey")
        console.log(collectionPaymentReceipt!);
        const printSettings = {
                    ...
                    {paymentReceipt ? (
                        <Grid container style={{ position: 'relative', justifyContent: "center", alignItems: "center" }} >
                            ...
                            <Grid container style={{ display: 'flex', justifyContent: "center", alignItems: "center" }}>
                                <Grid item>
                                    <StyleLabel style={{ marginLeft: 150 }}>Receipt ID</StyleLabel>
                                    <StyleData style={{ marginLeft: 150 }}>&nbsp; {paymentReceipt?.paymentreceiptid}</StyleData>
                                </Grid>
                                <Grid item>
                                    <StyleLabel style={{ marginLeft: -30 }}>Payment Transaction ID</StyleLabel>
                                    <StyleData style={{ marginLeft: -20 }}>{paymentReceipt?.paymenttransactionid}</StyleData>
                                </Grid>
                                <Grid item>
                                    <StyleLabel style={{ marginLeft: 30 }}>Dealer ID</StyleLabel>
                                ...
                                <Grid item>
                                    <StyleLabel style={{ marginLeft: -10 }}>Payment Type</StyleLabel>
                            ...
                            {paymentReceipt && paymentReceipt?.paymenttype === 'direct' ? (
                                ...
                                <div>
                                    <Grid container style={{ display: 'flex', justifyContent: "center", alignItems: "center" }}>
                                        <Grid item>
                                            <StyleLabel style={{ marginLeft: -320 }}>Date Collected</StyleLabel>
                                            <StyleData style={{ marginLeft: -290 }}>{new Date(collectionPaymentReceipt?.collectiondate!).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</StyleData>
                                        </Grid>
                                        <Grid item>
                                            <StyleLabel style={{ marginLeft: 0 }}>Amount Collected</StyleLabel>
                                    ...
                                    <Grid container style={{ display: 'flex', justifyContent: "center", alignItems: "center" }}>
                                        ...
                                        <Grid item>
                                            <StyleLabel style={{ marginLeft: 0 }}>Date Confirmed</StyleLabel>
                                        ...
                                        <Grid item>
                                            <StyleLabel style={{ marginLeft: 0 }}>Receiver Name</StyleLabel>
                                            <StyleData style={{ marginLeft: 20 }}>{collectionPaymentReceipt?.isconfirmed ? paymentReceipt?.receivername : ''}</StyleData>
                                        </Grid>
                                        <Grid item>
                                            <StyleLabel style={{ marginLeft: 0 }}>Remarks</StyleLabel>
                                            <StyleData style={{ marginLeft: 20 }}>{paymentReceipt?.remarks}</StyleData>
                                    ...
                                    <Grid container style={{ marginTop: 40, marginLeft: -250, display: 'flex', justifyContent: "center", alignItems: "center" }}>
                                        <Grid item style={{ marginLeft: 100, marginRight: 300 }}>
