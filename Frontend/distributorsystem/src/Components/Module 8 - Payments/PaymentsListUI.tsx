...
export default function PaymentList() {
    ...
    const isRowSelectable = (params: { row: { paymentStatus: string; }; }) => {
        // Disable checkbox for rows where payment status is 'Confirmed'
        return params.row.paymentStatus !== 'Confirmed';
      };
